...
void BleKeyboard::begin(void)
{
  ...
  //pSecurity->setAuthenticationMode(ESP_LE_AUTH_REQ_SC_MITM_BOND); //works with ipad pro
  pSecurity->setAuthenticationMode(ESP_LE_AUTH_BOND); //works with iphone Xs Max 17.1.1, ipad pro 12.9 5th 16.4.1, not my macbook pro 15 2018 12.4
